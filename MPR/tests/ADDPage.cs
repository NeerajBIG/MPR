...
namespace MPR.tests
{
    ...
    public class ADDShould : Base
    {
        ...
        [Test]
        //[Ignore("Ignore test")]
        public void VerifyADDPageLaunching()
        {
            ...
            ADDPageObject ADDPage = new ADDPageObject(getDriver());
            ...
            ADDPage.getclkADD().Click();
            Thread.Sleep(1000);

            string ADDPageHeading = ADDPage.getheadingText().Text;
            string ADDPageHeadingExpected = "24-Hour Accidental Death and Dismemberment";
            Assert.That(ADDPageHeading, Is.EqualTo(ADDPageHeadingExpected));
        }
